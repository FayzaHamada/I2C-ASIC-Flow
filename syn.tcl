#RUN This script when you are on script folder 
...
write -hierarchy -format verilog -output ../outputs/${design}_GTECH.v 
...
report_timing min -max_paths 10 > ../report/synth_timing.rpt 

report_timing -delay min > ../report/synth_timing_hold.rpt
