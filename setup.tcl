...
set reference_library /home/vlsi/Music/Flow/ndm/saed90nm_max_lth.ndm

#create design library from technology file & ndm

create_lib -technology $TECH_FILE -ref_libs $reference_library i2c_master_top.dlib

#read gate level netlist output from synthesis
read_verilog -top i2c_master_top ../../synth/outputs/i2c_master_top.v
...
read_sdc ../../synth/outputs/i2c_master_top.sdc
get_site_defs
