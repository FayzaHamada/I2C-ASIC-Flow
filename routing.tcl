...
write_verilog  outputs/Routing_output/${DESIGN_NAME}_Routing_Netlist.v

#SDC_OUT
write_sdc -output outputs/Routing_output/${DESIGN_NAME}_Routing_SDC.sdc
...
# SPEF_OUT
write_parasitics -format SPEF -output outputs/Routing_output/${DESIGN_NAME}_Routing_Spef.spef
...
######DEF_OUT
write_def outputs/Routing_output/${DESIGN_NAME}_Routing_def.def
...
outputs/Routing_output/${DESIGN_NAME}_Routing_GDS.gds
...
write_verilog  /home/vlsi/Music/Flow/PNR/outputs/Routing_output/Routing_netlist.v

#save block


save_block -as Routing i2c_master_top.dlib:Routing.design


# Export Reports

report_cell > /home/vlsi/Music/Flow/PNR/outputs/Routing_output/Routing_cells.rpt

report_qor  > /home/vlsi/Music/Flow/PNR/outputs/Routing_output/Routing_qor.rpt

report_timing -max_paths 10 > /home/vlsi/Music/Flow/PNR/outputs/Routing_output/Routing_timing.rpt

report_timing -delay min -max_paths 10 > /home/vlsi/Music/Flow/PNR/outputs/Routing_output/Routing_timing_hold.rpt

check_legality -verbose > /home/vlsi/Music/Flow/PNR/outputs/Routing_output/Routing_legalization.rpt

report_utilization > /home/vlsi/Music/Flow/PNR/outputs/Routing_output/Routing_legalization.rpt

report_routing_rules -verbose > /home/vlsi/Music/Flow/PNR/outputs/Routing_output/Routing_routing_rules.rpt

report_clock_routing_rules > /home/vlsi/Music/Flow/PNR/outputs/Routing_output/Routing_Clock_routing_rules.rpt

report_ports -verbose [get_ports *clk*] > /home/vlsi/Music/Flow/PNR/outputs/Routing_output/Routing_ports.rpt

report_clock_settings > /home/vlsi/Music/Flow/PNR/outputs/Routing_output/Routing_clk_setting.rpt
