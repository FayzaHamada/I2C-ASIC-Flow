...
open_block /home/vlsi/Music/Flow/PNR/Scripts/i2c_master_top.dlib:Foorplanning.design

# copy block to a new block to work on it

copy_block -from_block i2c_master_top.dlib:Foorplanning.design -to_block PowerPlanning
...
# We define the VDD and VSS in our RTL so we don't need to use the create_net and connect_pg_net commands

# If we want to use these commands, we have to create_net with another name like the vdd instead of VDD
...
save_block -as PowerPlanning i2c_master_top.dlib:PowerPlanning.design
...
report_cell > /home/vlsi/Music/Flow/PNR/outputs/Power_Planning_output/PP_cells.rpt

report_qor  > /home/vlsi/Music/Flow/PNR/outputs/Power_Planning_output/PP_qor.rpt

report_timing -max_paths 10 > /home/vlsi/Music/Flow/PNR/outputs/Power_Planning_output/PP_timing.rpt

report_timing -delay min -max_paths 10 > /home/vlsi/Music/Flow/PNR/outputs/Power_Planning_output/PP_timing_hold.rpt

check_legality -verbose > /home/vlsi/Music/Flow/PNR/outputs/Power_Planning_output/Power_Planning_legalization.rpt

report_utilization > /home/vlsi/Music/Flow/PNR/outputs/Power_Planning_output/Power_Planning_legalization.rpt
